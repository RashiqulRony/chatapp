<template>
    <div class="navigation navbar navbar-light bg-primary">
        ...
        <ul class="nav nav-minimal flex-row flex-grow-1 justify-content-between flex-xl-column justify-content-xl-center" id="mainNavTab" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link p-0 py-xl-3 active" @click="activeNav('chat')" title="Chats">
            ...
            <li class="nav-item">
                <a class="nav-link p-0 py-xl-3" @click="activeNav('group')" title="Friends">
                    <svg class="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li class="nav-item">
                <a class="nav-link p-0 py-xl-3" @click="activeNav('profile')" title="Profile">
                    <svg class="hw-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
    ...
    methods: {
        ...
        activeNav(type) {
            this.$store.dispatch('navBar', type)
        }
    }
}
</script>
