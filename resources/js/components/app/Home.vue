        ...
        <div class="chats">
            <div class="d-flex flex-column justify-content-center text-center h-100 w-100">
                <div class="container">
                    ...
                    <button @click="getUsers()" class="btn btn-outline-primary no-box-shadow">
                                    ...
                                    <li class="list-group-item" v-for="(user, index) in users" :key="index">
                                        <div class="media">
                                            ...
                                            <div class="media-options">
                                                ...
                                                <button class="btn btn-outline-primary no-box-shadow" title="Start Conversation" v-else>
...
<script>
    ...
    export default {
        ...
        methods: {
            getUsers() {
                http.get('get-users?key='+this.key).then((response) => response.data).then((response) => {
